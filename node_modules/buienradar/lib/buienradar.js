		...
		return new Promise((resolve, reject) => {
			...
			const alternativeRequest = () => {
				console.log(
					...
					`gadgets.buienradar.nl/data/raintext?lat=${this.lat}&lon=${this.lon}`
				);
				...
				req2.setTimeout(2000, () => reject('Requests timed out'));

				req2.end();
			};

			console.log('requesting data from', `gpsgadget.buienradar.nl/data/raintext?lat=${this.lat}&lon=${this.lon}`);
			...
			req.setTimeout(2000, alternativeRequest);
   ...
   * },
	...
	this.getRainData = function (forceRefresh) {
		...
		if (!forceRefresh && this.requestCacheTimeout && this.rainData) {
			return Promise.resolve(rainData);
		} else {
					...
					return new Promise((resolve, reject) => {
						...
						if (result && result.length && result.length > 1) {
							...
							if (this.requestCacheTimeout) {
								...
								console.log('got rain data result', result.length);
